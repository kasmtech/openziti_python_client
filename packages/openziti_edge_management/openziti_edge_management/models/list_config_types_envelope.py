...
class ListConfigTypesEnvelope(BaseModel):
    ...
    """ # noqa: E501
    data: List[ConfigTypeDetail] = Field(description="An array of config-type resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ConfigTypeDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
