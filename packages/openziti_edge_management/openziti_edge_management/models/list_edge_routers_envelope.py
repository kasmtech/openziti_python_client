...
class ListEdgeRoutersEnvelope(BaseModel):
    ...
    """ # noqa: E501
    data: List[EdgeRouterDetail] = Field(description="A list of edge router resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EdgeRouterDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
