...
class ListEnrollmentsEnvelope(BaseModel):
    ...
    """ # noqa: E501
    data: List[EnrollmentDetail] = Field(description="An array of enrollment resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EnrollmentDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
