...
class ControllerSettingDetail(BaseModel):
    """
    ...
    oidc: Optional[ControllerSettingsOidc] = None
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "tags", "updatedAt", "oidc"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oidc": ControllerSettingsOidc.from_dict(obj["oidc"]) if obj.get("oidc") is not None else None
        })
        return _obj
