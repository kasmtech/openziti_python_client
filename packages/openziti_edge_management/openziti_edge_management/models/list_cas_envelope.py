...
class ListCasEnvelope(BaseModel):
    ...
    ListCasEnvelope
    """ # noqa: E501
    data: List[CaDetail] = Field(description="An array of Certificate Authority (CA) resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CaDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
