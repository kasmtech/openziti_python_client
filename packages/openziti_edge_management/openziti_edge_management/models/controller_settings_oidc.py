...
class ControllerSettingsOidc(BaseModel):
    """
    ControllerSettingsOidc
    """ # noqa: E501
    post_logout_uris: Optional[List[StrictStr]] = Field(default=None, alias="postLogoutUris")
    redirect_uris: Optional[List[StrictStr]] = Field(default=None, alias="redirectUris")
    __properties: ClassVar[List[str]] = ["postLogoutUris", "redirectUris"]
