...
class CaDetail(BaseModel):
    ...
    name: StrictStr
    verification_token: Optional[UUID] = Field(default=None, alias="verificationToken")
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "tags", "updatedAt", "certPem", "externalIdClaim", "fingerprint", "identityNameFormat", "identityRoles", "isAuthEnabled", "isAutoCaEnrollmentEnabled", "isOttCaEnrollmentEnabled", "isVerified", "name", "verificationToken"]
