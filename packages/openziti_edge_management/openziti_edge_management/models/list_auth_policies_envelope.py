...
class ListAuthPoliciesEnvelope(BaseModel):
    ...
    """ # noqa: E501
    data: List[AuthPolicyDetail] = Field(description="An array of Auth Policies resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AuthPolicyDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
