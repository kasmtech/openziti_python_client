...
class PostureCheckProcessMultiPatch(PostureCheckPatch):
    ...
    """ # noqa: E501
    processes: Optional[Annotated[List[ProcessMulti], Field(min_length=1)]] = None
    semantic: Optional[Semantic] = None
    __properties: ClassVar[List[str]] = ["name", "roleAttributes", "tags", "typeId", "processes", "semantic"]
