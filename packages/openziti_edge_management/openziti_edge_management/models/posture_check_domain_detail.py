...
class PostureCheckDomainDetail(PostureCheckDetail):
    ...
    """ # noqa: E501
    domains: Annotated[List[StrictStr], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "domains"]
