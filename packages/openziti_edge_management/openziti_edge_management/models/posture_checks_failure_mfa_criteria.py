...
class PostureChecksFailureMfaCriteria(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["passedMfaAt", "timeoutRemainingSeconds", "timeoutSeconds", "unlockedAt", "wokenAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "passedMfaAt": obj.get("passedMfaAt"),
            "timeoutRemainingSeconds": obj.get("timeoutRemainingSeconds"),
            "timeoutSeconds": obj.get("timeoutSeconds"),
            "unlockedAt": obj.get("unlockedAt"),
            "wokenAt": obj.get("wokenAt")
        })
        return _obj
