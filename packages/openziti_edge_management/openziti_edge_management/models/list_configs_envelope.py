...
class ListConfigsEnvelope(BaseModel):
    ...
    ListConfigsEnvelope
    """ # noqa: E501
    data: List[ConfigDetail] = Field(description="An array of config resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ConfigDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
