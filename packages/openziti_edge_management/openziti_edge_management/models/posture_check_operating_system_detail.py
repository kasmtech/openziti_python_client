...
class PostureCheckOperatingSystemDetail(PostureCheckDetail):
    ...
    """ # noqa: E501
    operating_systems: List[OperatingSystem] = Field(alias="operatingSystems")
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "operatingSystems"]
