...
class AuthPolicyDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "tags", "updatedAt", "name", "primary", "secondary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "primary": AuthPolicyPrimary.from_dict(obj["primary"]) if obj.get("primary") is not None else None,
            "secondary": AuthPolicySecondary.from_dict(obj["secondary"]) if obj.get("secondary") is not None else None
        })
        return _obj
