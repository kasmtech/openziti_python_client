...
class ConfigPatch(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[Dict[str, Any]] = Field(default=None, description="Data payload is defined by the schema of the config-type defined in the type parameter")
    name: Optional[StrictStr] = None
    tags: Optional[Tags] = None
    __properties: ClassVar[List[str]] = ["data", "name", "tags"]
