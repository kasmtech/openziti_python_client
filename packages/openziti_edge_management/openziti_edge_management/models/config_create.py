...
class ConfigCreate(BaseModel):
    ...
    """ # noqa: E501
    config_type_id: StrictStr = Field(description="The id of a config-type that the data section will match", alias="configTypeId")
    ...
    __properties: ClassVar[List[str]] = ["configTypeId", "data", "name", "tags"]
