...
class ConfigTypeCreate(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    var_schema: Optional[Dict[str, Any]] = Field(default=None, description="A JSON schema to enforce configuration against", alias="schema")
    tags: Optional[Tags] = None
    __properties: ClassVar[List[str]] = ["name", "schema", "tags"]
