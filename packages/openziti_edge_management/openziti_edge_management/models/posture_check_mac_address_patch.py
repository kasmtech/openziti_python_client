...
class PostureCheckMacAddressPatch(PostureCheckPatch):
    ...
    """ # noqa: E501
    mac_addresses: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, alias="macAddresses")
    __properties: ClassVar[List[str]] = ["name", "roleAttributes", "tags", "typeId", "macAddresses"]
