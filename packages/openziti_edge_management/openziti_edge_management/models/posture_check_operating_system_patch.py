...
class PostureCheckOperatingSystemPatch(PostureCheckPatch):
    ...
    """ # noqa: E501
    operating_systems: Optional[Annotated[List[OperatingSystem], Field(min_length=1)]] = Field(default=None, alias="operatingSystems")
    __properties: ClassVar[List[str]] = ["name", "roleAttributes", "tags", "typeId", "operatingSystems"]
