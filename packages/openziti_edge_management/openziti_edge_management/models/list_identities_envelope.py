...
class ListIdentitiesEnvelope(BaseModel):
    ...
    """ # noqa: E501
    data: List[IdentityDetail] = Field(description="A list of identities")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [IdentityDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
