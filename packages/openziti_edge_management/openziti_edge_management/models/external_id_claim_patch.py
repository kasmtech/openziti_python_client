...
class ExternalIdClaimPatch(BaseModel):
    ...
    matcher_criteria: Optional[StrictStr] = Field(default=None, alias="matcherCriteria")
    parser: Optional[StrictStr] = None
    parser_criteria: Optional[StrictStr] = Field(default=None, alias="parserCriteria")
