...
class PolicyFailure(BaseModel):
    ...
    PolicyFailure
    """ # noqa: E501
    checks: Optional[List[PostureCheckFailure]] = None
    ...
    __properties: ClassVar[List[str]] = ["checks", "policyId", "policyName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checks": [PostureCheckFailure.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None,
