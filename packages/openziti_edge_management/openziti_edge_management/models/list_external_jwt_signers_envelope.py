...
class ListExternalJwtSignersEnvelope(BaseModel):
    ...
    """ # noqa: E501
    data: List[ExternalJwtSignerDetail] = Field(description="An array of External JWT Signers resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ExternalJwtSignerDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
