...
class PostureCheckProcessMultiDetail(PostureCheckDetail):
    ...
    """ # noqa: E501
    processes: Annotated[List[ProcessMulti], Field(min_length=1)]
    semantic: Semantic
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "processes", "semantic"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processes": [ProcessMulti.from_dict(_item) for _item in obj["processes"]] if obj.get("processes") is not None else None,
