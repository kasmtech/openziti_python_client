...
class PostureCheckMacAddressDetail(PostureCheckDetail):
    ...
    """ # noqa: E501
    mac_addresses: Annotated[List[StrictStr], Field(min_length=1)] = Field(alias="macAddresses")
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "macAddresses"]
