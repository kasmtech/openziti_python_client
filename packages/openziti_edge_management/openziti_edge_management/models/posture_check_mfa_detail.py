...
class PostureCheckMfaDetail(PostureCheckDetail):
    ...
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "ignoreLegacyEndpoints", "promptOnUnlock", "promptOnWake", "timeoutSeconds"]
