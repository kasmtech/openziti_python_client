...
class ConfigDetail(BaseModel):
    ...
    name: StrictStr
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "tags", "updatedAt", "configType", "configTypeId", "data", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configType": EntityRef.from_dict(obj["configType"]) if obj.get("configType") is not None else None,
            "configTypeId": obj.get("configTypeId"),
            "data": obj.get("data"),
            "name": obj.get("name")
        })
        return _obj
