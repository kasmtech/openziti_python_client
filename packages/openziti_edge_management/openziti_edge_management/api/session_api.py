...
class SessionApi:
    ...
    def detail_session_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DetailSessionManagementEnvelope]:
        """Retrieves a single session
    ...
    def detail_session_route_path(
        ...
        _param = self._detail_session_route_path_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def detail_session_route_path_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the requested resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DetailSessionRoutePathEnvelope]:
        """Retrieves a single session's router path
    ...
    @validate_call
    def detail_session_route_path_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the requested resource")],
        _request_timeout: Union[
            None,
    ...
    def _detail_session_route_path_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/sessions/{id}/route-path',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_sessions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListSessionsManagementEnvelope]:
        """List sessions
