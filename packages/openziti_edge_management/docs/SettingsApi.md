...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    api_instance = openziti_edge_management.SettingsApi(api_client)
    controller_setting = openziti_edge_management.ControllerSettingCreate() # ControllerSettingCreate | A controller settings object to create

    try:
        # Create a controller specific setting
        api_response = api_instance.create_controller_setting(controller_setting)
        print("The response of SettingsApi->create_controller_setting:\n")
        pprint(api_response)
...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SettingsApi->delete_controller_setting:\n")
        pprint(api_response)
    except Exception as e:
...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SettingsApi->detail_controller_setting:\n")
        pprint(api_response)
    except Exception as e:
...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SettingsApi->detail_controller_setting_effective:\n")
        pprint(api_response)
    except Exception as e:
...
> ListControllerSettingEnvelope list_controller_settings(limit=limit, offset=offset, filter=filter)
...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SettingsApi->list_controller_settings:\n")
        pprint(api_response)
    except Exception as e:
...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    api_instance = openziti_edge_management.SettingsApi(api_client)
    id = 'id_example' # str | The id of the requested resource
    controller_setting = openziti_edge_management.ControllerSettingPatch() # ControllerSettingPatch | A controller setting object patch object

    try:
        # Update the supplied fields on a controller setting object
        api_response = api_instance.patch_controller_setting(id, controller_setting)
        print("The response of SettingsApi->patch_controller_setting:\n")
        pprint(api_response)
    except Exception as e:
...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    api_instance = openziti_edge_management.SettingsApi(api_client)
    id = 'id_example' # str | The id of the requested resource
    controller_setting = openziti_edge_management.ControllerSettingUpdate() # ControllerSettingUpdate | A controller setting update object

    try:
        # Update all fields on a controller setting object
        api_response = api_instance.update_controller_setting(id, controller_setting)
        print("The response of SettingsApi->update_controller_setting:\n")
        pprint(api_response)
    except Exception as e:
