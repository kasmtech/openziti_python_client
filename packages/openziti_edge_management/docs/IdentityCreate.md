...
**is_admin** | **bool** |  | 
**name** | **str** |  | 
**permissions** | **List[str]** | A set of strings used to define which types of resources this resource can acccess | [optional] 
**role_attributes** | **List[str]** | A set of strings used to loosely couple this resource to policies | [optional] 
...
identity_create_from_dict = IdentityCreate.from_dict(identity_create_dict)
```
