...
posture_check_failure_operating_system_actual_from_dict = PostureCheckFailureOperatingSystemActual.from_dict(posture_check_failure_operating_system_actual_dict)
```
