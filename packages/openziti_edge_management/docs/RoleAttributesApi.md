...
> ListRoleAttributesEnvelope list_posture_check_role_attributes(limit=limit, offset=offset, filter=filter)
...
with openziti_edge_management.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoleAttributesApi->list_posture_check_role_attributes:\n")
        pprint(api_response)
    except Exception as e:
