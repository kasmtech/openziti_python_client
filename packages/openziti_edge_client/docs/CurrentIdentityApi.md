...
with openziti_edge_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openziti_edge_client.CurrentIdentityApi(api_client)
    mfa_validation = openziti_edge_client.MfaCode() # MfaCode | An MFA validation request
...
> DetailMfaRecoveryCodesEnvelope detail_mfa_recovery_codes(mfa_validation_code=mfa_validation_code, mfa_validation=mfa_validation)
...
with openziti_edge_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openziti_edge_client.CurrentIdentityApi(api_client)
    mfa_validation_code = 'mfa_validation_code_example' # str |  (optional)
    mfa_validation = openziti_edge_client.MfaCode() # MfaCode | An MFA validation request (optional)
...
with openziti_edge_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CurrentIdentityApi->get_current_identity_edge_routers:\n")
        pprint(api_response)
    except Exception as e:
