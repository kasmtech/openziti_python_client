...
identity_extend_validate_enrollment_request_from_dict = IdentityExtendValidateEnrollmentRequest.from_dict(identity_extend_validate_enrollment_request_dict)
```
