...
class IdentityAuthenticators(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cert", "updb"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cert": IdentityAuthenticatorsCert.from_dict(obj["cert"]) if obj.get("cert") is not None else None,
            "updb": IdentityAuthenticatorsUpdb.from_dict(obj["updb"]) if obj.get("updb") is not None else None
        })
        return _obj
