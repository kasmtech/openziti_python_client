...
class EnrollmentCertsEnvelope(BaseModel):
    """
    EnrollmentCertsEnvelope
    """ # noqa: E501
    data: Optional[EnrollmentCerts] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EnrollmentCerts.from_dict(obj["data"]) if obj.get("data") is not None else None,
