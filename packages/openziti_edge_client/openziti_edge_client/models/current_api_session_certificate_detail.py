...
class CurrentApiSessionCertificateDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_links", "createdAt", "id", "tags", "updatedAt", "certificate", "fingerprint", "subject", "validFrom", "validTo"]
