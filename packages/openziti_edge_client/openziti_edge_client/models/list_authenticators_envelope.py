...
class ListAuthenticatorsEnvelope(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[AuthenticatorDetail]] = Field(default=None, description="An array of authenticator resources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AuthenticatorDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
