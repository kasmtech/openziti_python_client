...
class PostureResponseEndpointStateCreate(PostureResponseCreate):
    """
    PostureResponseEndpointStateCreate
    """ # noqa: E501
    unlocked: Optional[StrictBool] = None
    woken: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "typeId", "unlocked", "woken"]
