...
class ListClientTerminatorsEnvelope(BaseModel):
    """
    ListClientTerminatorsEnvelope
    """ # noqa: E501
    data: List[TerminatorClientDetail]
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TerminatorClientDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
