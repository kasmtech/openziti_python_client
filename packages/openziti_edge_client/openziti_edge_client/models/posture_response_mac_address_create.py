...
class PostureResponseMacAddressCreate(PostureResponseCreate):
    """
    PostureResponseMacAddressCreate
    """ # noqa: E501
    mac_addresses: List[StrictStr] = Field(alias="macAddresses")
    __properties: ClassVar[List[str]] = ["id", "typeId", "macAddresses"]
