...
class ListCurrentIdentityEdgeRoutersEnvelope(BaseModel):
    """
    ListCurrentIdentityEdgeRoutersEnvelope
    """ # noqa: E501
    data: List[CurrentIdentityEdgeRouterDetail] = Field(description="A list of edge router resources")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CurrentIdentityEdgeRouterDetail.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
