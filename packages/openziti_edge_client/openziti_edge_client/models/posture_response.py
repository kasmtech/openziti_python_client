...
class PostureResponse(BaseModel):
    ...
    PostureResponse
    """ # noqa: E501
    services: List[PostureResponseService]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services": [PostureResponseService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
